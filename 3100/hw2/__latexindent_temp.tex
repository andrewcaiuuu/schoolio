...
\begin{math}
  ...
  1-\frac{1}{2}(2-a)\textsuperscript{2} \; \textrm{for } 1 < a \leq 2
\end{math} This is calculated by dividing the area of the region of choice by the area 
of the unit square.
...
\begin{enumerate}[label=\alph*.]
  ...
  For that one way, there are (n-m)! ways the remaining students can draw a name.
  As a result, the probability is given by $\frac{(n-m)!}{n!}$
  \item There are m! ways that everyone among the first m students to draw gets a name of
  the last m students to draw. For these m! ways, there are (n-m)! ways the remaining students can
  draw a name. As a result, the probability is given by $\frac{(n-m)!m!}{n!}$
